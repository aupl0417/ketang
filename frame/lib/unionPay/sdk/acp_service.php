...
include_once FRAMEROOT.'/lib/unionPay/sdk/log.class.php';
include_once FRAMEROOT.'/lib/unionPay/sdk/common.php';
include_once FRAMEROOT.'/lib/unionPay/sdk/SDKConfig.php';
include_once FRAMEROOT.'/lib/unionPay/sdk/secureUtil.php';
// 初始化日志
